#ifndef GTKMM_GLOBAL_H
#define GTKMM_GLOBAL_H
/**
 *	\file global.h
...
// Conditional class needed by HAPviewer
#define USE_CFLOWFILTER
...
public:
	...
	bool filter_unprod_outflows; ///< True when unprpductive outflows should be filtered
	...
	bool warn_oversized_graphlet; ///< True when user should be warned before overesized graphlets
	...
	void show_prefs() {
		std::cout << "summarize_clt_roles:     "
				<< (summarize_clt_roles ? "true" : "false") << std::endl;
		std::cout << "summarize_multclt_roles: "
				<< (summarize_multclt_roles ? "true" : "false") << std::endl;
		std::cout << "summarize_srv_roles:     "
				<< (summarize_srv_roles ? "true" : "false") << std::endl;
		std::cout << "summarize_p2p_roles:     "
				<< (summarize_p2p_roles ? "true" : "false") << std::endl;
		std::cout << std::endl;
		std::cout << "summarize_biflows:       "
				<< (summarize_biflows ? "true" : "false") << std::endl;
		std::cout << "summarize_uniflows:      "
				<< (summarize_uniflows ? "true" : "false") << std::endl;
		std::cout << std::endl;
		std::cout << "filter_biflows:          "
				<< (filter_biflows ? "true" : "false") << std::endl;
		std::cout << "filter_uniflows:         "
				<< (filter_uniflows ? "true" : "false") << std::endl;
		std::cout << "filter_unprod_inflows:   "
				<< (filter_unprod_inflows ? "true" : "false") << std::endl;
		std::cout << "filter_unprod_outflows:  "
				<< (filter_unprod_outflows ? "true" : "false") << std::endl;
		std::cout << std::endl;
		std::cout << "filter_TCP:              "
				<< (filter_TCP ? "true" : "false") << std::endl;
		std::cout << "filter_UDP:              "
				<< (filter_UDP ? "true" : "false") << std::endl;
		std::cout << "filter_ICMP:             "
				<< (filter_ICMP ? "true" : "false") << std::endl;
		std::cout << "filter_OTHER:            "
				<< (filter_OTHER ? "true" : "false") << std::endl;
		std::cout << std::endl;
		std::cout << "warn_oversized_graphlet: "
				<< (warn_oversized_graphlet ? "true" : "false") << std::endl;
	}
};
#endif
